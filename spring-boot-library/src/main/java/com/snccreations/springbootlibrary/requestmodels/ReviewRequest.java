...
public class ReviewRequest {
    ...
    private Long bookId;
    private Optional<String> reviewDescription = Optional.empty(); // Initialize with Optional.empty()
    ...
    public void setReviewDescription(Optional<String> reviewDescription) {
        this.reviewDescription = reviewDescription != null ? reviewDescription : Optional.empty();
    }
}
